...
public class EditSparePartsResponse extends BaseResponseHandler {
    public EditSparePartsResponse(CallbackType callbackType) {
        super(callbackType);
    }
    ...
    public void respond() {
        ...
        setText(getEditSparePartsText(part, level, spare, locale));
        setKeyboardMarkup(editSparePartsMarkup(part, level, spare, locale));
    }
